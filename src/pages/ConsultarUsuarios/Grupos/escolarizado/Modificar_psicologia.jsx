...
export default function ConsultarAlumnosPsicologia() {
  ...
  useEffect(() => {
    const fetchAlumnos = async () => {
      try {
        const response = await axios.get("http://localhost:4000/ConsultarAlumnosPsicologia");
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <Navbar titulo="Modificar Alumnos Psicología" />
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-800">Lista de Alumnos de Psicología</h1>
        </div>
