...
export default function ConsultarAlumnosPedagogiaVirtual() {
  ...
  useEffect(() => {
    const fetchAlumnos = async () => {
      try {
        const response = await axios.get("http://localhost:4000/ConsultarAlumnosPedagogiaVirtual");
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <Navbar titulo="Modificar Alumnos Pedagogía Virtual" />
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-800">Lista de Alumnos de Pedagogía Virtual</h1>
        </div>
