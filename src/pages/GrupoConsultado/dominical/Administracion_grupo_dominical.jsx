...
export default function AdministracionDominical_grupo() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para alumnos de Administración Dominical
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosAdministracionDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Administración (Modalidad Dominical)", 14, 20);
    ...
    doc.save("alumnos_administracion_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Administración Dominical");

    XLSX.writeFile(workbook, "alumnos_administracion_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Administración - Modalidad Dominical" />
