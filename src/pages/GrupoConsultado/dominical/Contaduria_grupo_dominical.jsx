...
export default function ContaduriaDominical() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Ruta adaptada a la carrera de Contaduría Dominical
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosContaduriaDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Contaduría (Dominical)", 14, 20);
    ...
    doc.save("alumnos_contaduria_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Contaduría Dominical");

    XLSX.writeFile(workbook, "alumnos_contaduria_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Licenciatura en Contaduría - Modalidad Dominical" />
