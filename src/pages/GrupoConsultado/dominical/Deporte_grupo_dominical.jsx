...
export default function DeporteDominical() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint de la carrera Deporte Dominical
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosDeporteDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Carrera de Deporte Dominical", 14, 20);
    ...
    doc.save("alumnos_deporte_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Deporte Dominical");

    XLSX.writeFile(workbook, "alumnos_deporte_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Carrera de Deporte Dominical - Alumnos" />
