...
export default function DerechoDominical() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint adaptado a Derecho Dominical
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosDerechoDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Derecho (Dominical)", 14, 20);
    ...
    doc.save("alumnos_derecho_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Derecho Dominical");

    XLSX.writeFile(workbook, "alumnos_derecho_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      {/* 🔹 Título actualizado */}
      <Navbar titulo="Carrera de Derecho - Modalidad Dominical" />
