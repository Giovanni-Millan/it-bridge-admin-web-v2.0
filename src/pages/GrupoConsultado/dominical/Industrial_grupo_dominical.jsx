...
export default function IndustrialDominical() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint adaptado
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosIndustrialDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Ingeniería Industrial (Dominical)", 14, 20);
    ...
    doc.save("alumnos_industrial_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Industrial Dominical");

    XLSX.writeFile(workbook, "alumnos_industrial_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Ingeniería Industrial - Dominical" />
