...
export default function PedagogiaDominical() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint actualizado a la ruta específica de Pedagogía Dominical
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosPedagogiaDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Licenciatura en Pedagogía (Dominical)", 14, 20);
    ...
    doc.save("alumnos_pedagogia_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Pedagogía Dominical");

    XLSX.writeFile(workbook, "alumnos_pedagogia_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Licenciatura en Pedagogía - Modalidad Dominical" />
