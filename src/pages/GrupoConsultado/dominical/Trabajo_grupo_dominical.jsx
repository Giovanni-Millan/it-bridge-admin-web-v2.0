...
export default function TrabajoSocialDominical() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint actualizado a /ConsultarAlumnosTrabajoSocialDominical
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosTrabajoSocialDominical')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Trabajo Social (Dominical)", 14, 20);
    ...
    doc.save("alumnos_trabajo_social_dominical.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Trabajo Social - Dominical");

    XLSX.writeFile(workbook, "alumnos_trabajo_social_dominical.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Trabajo Social - Dominical" />
