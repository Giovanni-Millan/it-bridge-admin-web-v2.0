...
export default function Deporte_grupo() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Ruta actualizada para la carrera de Deporte
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosDeporte')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Licenciatura en Deporte", 14, 20);
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Deporte");

    XLSX.writeFile(workbook, "alumnos_deporte.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Licenciatura en Deporte - Alumnos" />
