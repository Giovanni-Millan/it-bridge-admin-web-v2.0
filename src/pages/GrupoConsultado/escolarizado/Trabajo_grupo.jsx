...
export default function TrabajoSocial_grupo() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Ruta actualizada a Trabajo Social
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosTrabajoSocial')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Licenciatura en Trabajo Social", 14, 20);
    ...
    doc.save("alumnos_trabajo_social.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Trabajo Social");

    XLSX.writeFile(workbook, "alumnos_trabajo_social.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Licenciatura en Trabajo Social - Alumnos" />
