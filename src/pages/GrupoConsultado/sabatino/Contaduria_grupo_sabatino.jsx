...
export default function ContaduriaSabatino() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Ruta actualizada para la carrera Contaduría Sabatino
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosContaduriaSabatino')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Contaduría (Sabatino)", 14, 20);
    ...
    doc.save("alumnos_contaduria_sabatino.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Contaduría Sabatino");

    XLSX.writeFile(workbook, "alumnos_contaduria_sabatino.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      {/* 🔹 Título en el navbar */}
      <Navbar titulo="Contaduría - Modalidad Sabatina" />
