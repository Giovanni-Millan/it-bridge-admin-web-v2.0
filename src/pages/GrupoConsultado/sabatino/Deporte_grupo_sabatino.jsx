...
export default function DeporteSabatino_grupo() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para la carrera de Deporte Sabatino
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosDeporteSabatino')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Licenciatura en Deporte (Sabatino)", 14, 20);
    ...
    doc.save("alumnos_deporte_sabatino.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Deporte Sabatino");

    XLSX.writeFile(workbook, "alumnos_deporte_sabatino.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Licenciatura en Deporte (Sabatino) - Alumnos" />
