...
export default function DerechoSabatino_grupo() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint adaptado a /ConsultarAlumnosDerechoSabatino
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosDerechoSabatino')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Licenciatura en Derecho (Sabatino)", 14, 20);
    ...
    doc.save("alumnos_derecho_sabatino.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Derecho Sabatino");

    XLSX.writeFile(workbook, "alumnos_derecho_sabatino.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Licenciatura en Derecho - Modalidad Sabatina" />
