...
export default function IndustrialSabatino() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint adaptado a /ConsultarAlumnosIndustrialSabatino
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosIndustrialSabatino')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Ingeniería Industrial (Sabatino)", 14, 20);
    ...
    doc.save("alumnos_industrial_sabatino.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Industrial Sabatino");

    XLSX.writeFile(workbook, "alumnos_industrial_sabatino.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Ingeniería Industrial - Sabatino" />
