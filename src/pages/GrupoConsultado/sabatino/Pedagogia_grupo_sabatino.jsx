...
export default function PedagogiaSabatino() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint específico para Pedagogía Sabatino
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosPedagogiaSabatino')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Pedagogía Sabatino", 14, 20);
    ...
    doc.save("alumnos_pedagogia_sabatino.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Pedagogía Sabatino");

    XLSX.writeFile(workbook, "alumnos_pedagogia_sabatino.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      {/* 🔹 Título en el Navbar */}
      <Navbar titulo="Carrera de Pedagogía Sabatino - Alumnos" />
