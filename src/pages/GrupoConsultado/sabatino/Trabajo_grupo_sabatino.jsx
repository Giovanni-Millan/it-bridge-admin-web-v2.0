...
export default function TrabajoSocialSabatino() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint específico para la carrera de Trabajo Social Sabatino
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosTrabajoSocialSabatino')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Trabajo Social (Sabatino)", 14, 20);
    ...
    doc.save("alumnos_trabajo_social_sabatino.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Trabajo Social Sabatino");

    XLSX.writeFile(workbook, "alumnos_trabajo_social_sabatino.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Trabajo Social (Sabatino) - Alumnos" />
