...
export default function AdministracionVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Administración - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosAdministracionVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Administración (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_administracion_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Administración Virtual");

    XLSX.writeFile(workbook, "alumnos_administracion_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Administración - Modalidad Virtual" />
