...
export default function ContaduriaVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Contaduría - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosContaduriaVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Contaduría (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_contaduria_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Contaduría Virtual");

    XLSX.writeFile(workbook, "alumnos_contaduria_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Contaduría - Modalidad Virtual" />
