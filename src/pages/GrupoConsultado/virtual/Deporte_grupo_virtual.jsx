...
export default function DeporteVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Deporte - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosDeporteVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Deporte (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_deporte_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Deporte Virtual");

    XLSX.writeFile(workbook, "alumnos_deporte_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Deporte - Modalidad Virtual" />
