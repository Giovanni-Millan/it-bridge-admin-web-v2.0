...
export default function IndustrialVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Ingeniería Industrial - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosIndustrialVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Ingeniería Industrial (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_industrial_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Industrial Virtual");

    XLSX.writeFile(workbook, "alumnos_industrial_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Ingeniería Industrial - Modalidad Virtual" />
