...
export default function PedagogiaVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Pedagogía - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosPedagogiaVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Pedagogía (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_pedagogia_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Pedagogía Virtual");

    XLSX.writeFile(workbook, "alumnos_pedagogia_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Pedagogía - Modalidad Virtual" />
