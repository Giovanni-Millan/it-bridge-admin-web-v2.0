...
export default function PsicologiaVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Psicología - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosPsicologiaVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Psicología (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_psicologia_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Psicología Virtual");

    XLSX.writeFile(workbook, "alumnos_psicologia_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Psicología - Modalidad Virtual" />
