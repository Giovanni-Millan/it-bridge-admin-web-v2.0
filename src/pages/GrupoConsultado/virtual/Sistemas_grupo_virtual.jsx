...
export default function Semestre6() {
  ...
  // 🔹 Endpoint para la modalidad Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosSistemasVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Ingeniería en Sistemas (Virtual)", 14, 20);
    ...
    doc.save("alumnos_sistemas_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Sistemas - Virtual");

    XLSX.writeFile(workbook, "alumnos_sistemas_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      <Navbar titulo="Ingeniería en Sistemas - Virtual" />
