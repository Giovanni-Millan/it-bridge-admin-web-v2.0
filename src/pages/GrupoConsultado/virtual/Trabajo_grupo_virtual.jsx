...
export default function TrabajoSocialVirtual() {
  const [alumno, setAlumno] = useState([]);

  // 🔹 Endpoint para Trabajo Social - Virtual
  useEffect(() => {
    axios.get('http://localhost:4000/ConsultarAlumnosTrabajoSocialVirtual')
  ...
  const exportPDF = () => {
    ...
    doc.text("Lista de Alumnos - Trabajo Social (Modalidad Virtual)", 14, 20);
    ...
    doc.save("alumnos_trabajosocial_virtual.pdf");
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Alumnos Trabajo Social Virtual");

    XLSX.writeFile(workbook, "alumnos_trabajosocial_virtual.xlsx");
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <Navbar titulo="Trabajo Social - Modalidad Virtual" />
