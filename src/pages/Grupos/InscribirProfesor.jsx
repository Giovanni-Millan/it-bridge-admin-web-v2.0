...
export default function InscribirProfesor() {
  ...
  const handleChange = (e) => {
    ...
    if (["nombre", "apellido_paterno", "apellido_materno"].includes(name)) {
      ...
      actualizado.contraseña = generarPassword("Docente", actualizado.nombre);
    }
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Profesor inscrito correctamente",
        text: `${nombreCompleto} ya puede iniciar sesión en el Portal del Docente.`,
        icon: "success",
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-100">
      <Navbar titulo="Inscribir Profesor" />
